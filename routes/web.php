...
Route::get('/job-offers', [JobOfferController::class, 'index'])->name('job-offer.index');
Route::get('/job-offers/{jobOffer}', [JobOfferController::class, 'show'])->name('job-offer.show');
